                        ...
                        switch (CPU_Regs.reg_eax.low()) {
                            ...
                            case 0x0c: {    /* VCPI Switch from V86 to Protected Mode */
                                ...
                                if (CPU.CPU_LLDT(new_ldt))
                                    logger.log(Level.DEBUG, "VCPI:Could not load LDT with " + Integer.toString(new_ldt, 16));
                                if (CPU.CPU_LTR(new_tr))
                                    logger.log(Level.DEBUG, "VCPI:Could not load TR with " + Integer.toString(new_tr, 16));
