                    ...
                    switch (CPU_Regs.reg_eax.low()) {
                        ...
                        case 0x08: // ENABLE/DISABLE POWER MANAGEMENT
                            ...
                            if (CPU_Regs.reg_ecx.word() == 0x0)
                                logger.log(Level.DEBUG, "disable APM for device " + Integer.toString(CPU_Regs.reg_ebx.word(), 16));
                            else if (CPU_Regs.reg_ecx.word() == 0x1)
                                logger.log(Level.DEBUG, "enable APM for device " + Integer.toString(CPU_Regs.reg_ebx.word(), 16));
                            else {
                                CPU_Regs.reg_eax.high(0x0A); // invalid parameter value in CX
                                Callback.CALLBACK_SCF(true);
                            }
                        ...
                        case 0x0f:
                            ...
                            if (CPU_Regs.reg_ecx.word() == 0x0)
                                logger.log(Level.DEBUG, "disengage APM for device " + Integer.toString(CPU_Regs.reg_ebx.word(), 16));
                            else if (CPU_Regs.reg_ecx.word() == 0x1)
                                logger.log(Level.DEBUG, "engage APM for device " + Integer.toString(CPU_Regs.reg_ebx.word(), 16));
                            else {
                                CPU_Regs.reg_eax.high(0x0A); // invalid parameter value in CX
                                Callback.CALLBACK_SCF(true);
                            }
