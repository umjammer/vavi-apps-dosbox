...
public class Prefix_none extends StringOp {
    ...
    static {
        ...
        ops[0x88] = () -> {
            ...
            if (rm >= 0xc0) {
                int value = switch ((rm >> 3) & 7) {
                    ...
                    case 6 -> reg_edx.high();
                    case 7 -> reg_ebx.high();
                    default -> 0; // shouldn't be possible
                };
                switch (rm & 7) {
        ...
        ops[0x8c] = () -> {
            ...
            default:
                LOG_CPU.log(Level.ERROR, "CPU:8c:Illegal RM Byte");
        ...
        ops[0xd8] = () -> {
            if (Config.C_FPU)
            {
                ...
                /*Bit8u*/int rm=Fetchb();
                LOG_CPU.log(Level.DEBUG, "FPU used");
        ...
        /* LOCK */
        ops[0xf0] = () -> {
            //LOG_CPU.log(Level.DEBUG, "CPU:LOCK"); /* FIXME: see case D_LOCK in core_full/new Instructions.load()h */
            ...
            case 0x01:											/* TEST Eb,Ib Undocumented*/
                {
                    if (rm >= 0xc0 ) {
                        ...
                        int val = Memory.mem_readb(getEaa(rm));
                        TESTB(Fetchb(),val);
                    }
                    break;
                }
        ...
        ops[0xff] = () -> {
            ...
            case 0x06:										/* PUSH Ev */
                ...
                break;
            default:
                LOG_CPU.log(Level.ERROR, "CPU:GRP5:Illegal Call "+Integer.toString(which,16));
                return ILLEGAL_OPCODE;
            }
            return HANDLED;
        };
