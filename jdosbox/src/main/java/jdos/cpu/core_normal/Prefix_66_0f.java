    ...
    static {
        ...
        ops[0x300] = () -> {
            ...
            case 0x02:case 0x03:case 0x04:case 0x05:
                ...
                break;
            default:
                LOG_CPU.log(Level.ERROR, "GRP6:Illegal call "+Integer.toString(which,16));
        ...
        ops[0x301] = () -> {
            ...
            if (rm < 0xc0)	{ //First ones all use EA
                ...
                case 0x06:										/* LMSW */
                    ...
                    break;
                default:
                    LOG_CPU.log(Level.ERROR, "Illegal group 7 RM subfunction "+which);
                    return ILLEGAL_OPCODE;
                }
...
//                    }
//                }
//                logger.log(Level.DEBUG,System.currentTimeMillis()-start);
        ...
        ops[0x3ba] = () -> {
            ...
            if (rm >= 0xc0 ) {
                ...
                case 0x38:											/* BTC */
                    ...
                    break;
                default:
                    throw new IllegalStateException("CPU:66:0F:BA:Illegal subfunction "+Integer.toString(rm & 0x38,16));
                }
            } else {
