...
public class VGA_other {
    ...
    private static final Logger logger = System.getLogger(VGA_other.class.getName());
    ...
    private static final IoHandler.IO_WriteHandler write_crtc_data_other = (port, val, iolen) -> {
        ...
        case 0x11:	/* Light Pen Low */
            ...
            break;
        default:
            LOG_VGAMISC.log(Level.DEBUG, "MC6845:Write "+Integer.toString(val, 16)+" to illegal index "+Integer.toString(VGA.vga.other.index,16));
        }
    };
    ...
    private static final IoHandler.IO_ReadHandler read_crtc_data_other = (port, iolen) -> {
        ...
        default:
            LOG_VGAMISC.log(Level.DEBUG, "MC6845:Read from illegal index "+Integer.toString(VGA.vga.other.index,16));
        }
        /*Bitu*/
        return ~0;
    };
...
// to match an entry that is generated here.
    ...
    private static final Mapper.MAPPER_Handler IncreaseHue = pressed -> {
        ...
        hue_offset += 5.0;
        update_cga16_color();
        logger.log(Level.DEBUG, "Hue at "+hue_offset);
    };
    ...
    private static final Mapper.MAPPER_Handler DecreaseHue = pressed -> {
        ...
        hue_offset -= 5.0;
        update_cga16_color();
        logger.log(Level.DEBUG, "Hue at %f"+hue_offset);
    };
    ...
    private static void write_tandy_reg(/*Bit8u*/short val) {
        ...
        case 0x0:
            if (Dosbox.machine==MachineType.MCH_PCJR) {
                ...
                LOG_VGAMISC.log(Level.DEBUG, "Unhandled Write "+Integer.toString(val, 16)+" to tandy reg "+Integer.toString(VGA.vga.tandy.reg_index,16));
            }
            break;
...
/* static Bitu read_hercules(Bitu port,Bitu iolen) {
	logger.log(Level.DEBUG, "read from Herc port %x",port);
	return 0;
} */
