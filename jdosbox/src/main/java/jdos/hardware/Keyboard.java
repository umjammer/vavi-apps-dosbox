...
public class Keyboard {
    ...
    private static final Logger logger = System.getLogger(Keyboard.class.getName());
    private static final Logger LOG_KEYBOARD = System.getLogger("LOG_KEYBOARD");
    ...
    private static final Pic.PIC_EventHandler KEYBOARD_TransferBuffer = new Pic.PIC_EventHandler() {
        ...
        public void call(/*Bitu*/int val) {
            ...
            if (keyb.used==0) {
                LOG_KEYBOARD.log(Level.DEBUG, "Transfer started with empty buffer");
                return;
            }
    ...
    static void KEYBOARD_Add8042Response(int data) {
        ...
        if (keyb.buf8042_pos >= keyb.buf8042.length) {
            logger.log(Level.DEBUG, "8042 Buffer full, dropping code");
            return;
        }
    ...
    public static void KEYBOARD_AddBuffer(/*Bit8u*/int data) {
        if (keyb.used>=KEYBUFSIZE) {
            LOG_KEYBOARD.log(Level.DEBUG, "Buffer full, dropping code");
            return;
        }
    ...
    static void KEYBOARD_AUX_Write(int val) {
        ...
        switch (keyb.aux_command) {
            case ACMD_NONE:
                switch (val) {
                    case 0xff:	/* reset */
                        LOG_KEYBOARD.log(Level.DEBUG, "AUX reset");
                    ...
                    case 0xe7:	/* set scaling 2:1 */
                        ...
                        LOG_KEYBOARD.log(Level.DEBUG, "PS/2 mouse scaling 2:1");
                        break;
                    case 0xe6:	/* set scaling 1:1 */
                        KEYBOARD_AddBuffer(AUX|0xfa);	/* ack */
                        keyb.ps2mouse.scale21 = false;
                        LOG_KEYBOARD.log(Level.DEBUG, "PS/2 mouse scaling 1:1");
                        break;
                }
                break;
            case ACMD_SET_RATE:
                ...
                LOG_KEYBOARD.log(Level.DEBUG, "PS/2 mouse sample rate set to "+val);
                    ...
                    if (keyb.ps2mouse.last_srate[0] == 200 && keyb.ps2mouse.last_srate[2] == 80) {
                        if (keyb.ps2mouse.last_srate[1] == 100) {
                            if (!keyb.ps2mouse.intellimouse_mode) {
                                LOG_KEYBOARD.log(Level.DEBUG, "Intellimouse mode enabled");
                                keyb.ps2mouse.intellimouse_mode=true;
                            }
                        }
                        else if (keyb.ps2mouse.last_srate[1] == 200 && keyb.ps2mouse.type >= MOUSE_INTELLIMOUSE45) {
                            if (!keyb.ps2mouse.intellimouse_btn45) {
                                LOG_KEYBOARD.log(Level.DEBUG, "Intellimouse 4/5-button mode enabled");
            ...
            case ACMD_SET_RESOLUTION:
                ...
                LOG_KEYBOARD.log(Level.DEBUG, "PS/2 mouse resolution set to "+(1 << (val&3)));
                break;
        }
    }
    ...
    private static final IoHandler.IO_WriteHandler write_p60 = (port, val, iolen) -> {
        ...
        case KeyCommands.CMD_NONE:	/* None */
            ...
            case 0xf4:	/* Enable keyboard,clear buffer, start scanning */
                LOG_KEYBOARD.log(Level.DEBUG, "Clear buffer,enable Scaning");
                KEYBOARD_Add8042Response(0xfa);	/* Acknowledge */
                keyb.scanning=true;
                break;
            case 0xf5:	 /* Reset keyboard and disable scanning */
                LOG_KEYBOARD.log(Level.DEBUG, "Reset, disable scanning");
                keyb.scanning=false;
                KEYBOARD_Add8042Response(0xfa);	/* Acknowledge */
                break;
            case 0xf6:	/* Reset keyboard and enable scanning */
                LOG_KEYBOARD.log(Level.DEBUG, "Reset, enable scanning");
                KEYBOARD_Add8042Response(0xfa);	/* Acknowledge */
                keyb.scanning=true;
                break;
            //case 0:
            ...
            default:
                ...
                LOG_KEYBOARD.log(Level.ERROR, "60:Unhandled command "+Integer.toString(val,16));
                KEYBOARD_AddBuffer(0xfa);	/* Acknowledge */
            }
            return;
    ...
    private static final IoHandler.IO_WriteHandler write_p64 = (port, val, iolen) -> {
        ...
        case 0xa7:		/* disable aux */
            if (keyb.enable_aux) {
                ...
                LOG_KEYBOARD.log(Level.DEBUG, "AUX De-Activated");
            }
            break;
        case 0xa8:		/* enable aux */
            if (keyb.enable_aux) {
                ...
                LOG_KEYBOARD.log(Level.DEBUG, "AUX Activated");
            }
            break;
        ...
        case 0xae:		/* Activate keyboard */
            ...
            LOG_KEYBOARD.log(Level.DEBUG, "Activated");
            break;
        case 0xad:		/* Deactivate keyboard */
            keyb.active=false;
            LOG_KEYBOARD.log(Level.DEBUG, "De-Activated");
            break;
        ...
        case 0xd3:		/* write AUX output */
            if (keyb.enable_aux)
                ...
                LOG_KEYBOARD.log(Level.DEBUG,  "Program is writing 8042 AUX. If you intend to use PS/2 mouse emulation you may consider adding aux=1 to your dosbox.conf");
            break;
        ...
        case 0xf8: case 0xf9: case 0xfa: case 0xfb: case 0xfc: case 0xfd: case 0xfe: case 0xff:
            ...
            break;
        default:
            LOG_KEYBOARD.log(Level.ERROR, "Port 64 write with val "+val);
            break;
        }
    };
    ...
    static public void KEYBOARD_AddKey(int keytype,boolean pressed) {
        ...
        case KBD_KEYS.KBD_printscreen:
            ...
            return;
        default:
            throw new IllegalStateException("Unsupported key press");
        }
    ...
    public static final Section.SectionFunction KEYBOARD_Init = sec -> {
        ...
        if (keyb.enable_aux=section.Get_bool("aux")) {
            LOG_KEYBOARD.log(Level.DEBUG, "Keyboard AUX emulation enabled");
        }
        ...
        if (sbtype != null) {
            if (sbtype.equals("2button"))
                ...
                keyb.ps2mouse.type=MOUSE_INTELLIMOUSE;
                LOG_KEYBOARD.log(Level.ERROR,  "Assuming PS/2 intellimouse, I don't know what '"+sbtype+"' is");
            }
        }
    ...
    static private void AUX_Reset() {
        ...
        if (keyb.ps2mouse.type != MOUSE_NONE && keyb.ps2mouse.int33_taken)
            LOG_KEYBOARD.log(Level.DEBUG, "PS/2 mouse emulation: taking over from INT 33h");
        keyb.ps2mouse.int33_taken = false;
    ...
    static public void AUX_INT33_Takeover() {
        if (keyb.ps2mouse.type != MOUSE_NONE && keyb.ps2mouse.int33_taken)
            LOG_KEYBOARD.log(Level.DEBUG, "PS/2 mouse emulation: Program is using INT 33h, disabling direct AUX emulation");
