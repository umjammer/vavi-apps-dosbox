...
public class VGA_attr {
        ...
        if (!VGA.vga.internal.attrindex) {
            ...
            */
            ...
            default:
                ...
                LOG_VGAMISC.log(Level.DEBUG, "VGA:ATTR:Write to unkown Index "+Integer.toString(VGA.vga.attr.index,16));
                break;
            }
        }
    };
    ...
    //	vga.internal.attrindex=false;
        ...
        default:
            ...
            LOG_VGAMISC.log(Level.DEBUG, "VGA:ATTR:Read from unkown Index "+Integer.toString(VGA.vga.attr.index,16));
        }
        return 0;
    };
