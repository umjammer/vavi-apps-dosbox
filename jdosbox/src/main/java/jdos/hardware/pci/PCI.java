...
public class PCI extends Module_base {
    ...
    private static final Logger logger = System.getLogger(PCI.class.getName());
    private static final Logger LOG_PCI = System.getLogger("LOG_PCI");
    ...
    static private final IoHandler.IO_WriteHandler write_pci_addr = (port, val, iolen) -> {
        LOG_PCI.log(Level.DEBUG, "Write PCI address :=" + Integer.toString(val, 16));
        pci_caddress = val;
    };
    ...
    static private final IoHandler.IO_WriteHandler write_pci = (port, val, iolen) -> {
        LOG_PCI.log(Level.DEBUG, "Write PCI data :=" + Integer.toString(val, 16) + " (len " + iolen + ")");
        ...
        if ((pci_caddress & 0x80ff0000) == 0x80000000) {
            ...
            LOG_PCI.log(Level.DEBUG, "  Write to device " + Integer.toString(devnum, 16) + " register " + Integer.toString(regnum, 16) + " (function " + Integer.toString(fctnum, 16) + ") (:=" + Integer.toString(val, 16) + ")");
            ...
            if (dev == null) return;
            logger.log(Level.DEBUG, "PCI 0x" + Integer.toHexString(dev.PCIId()) + " write " + Integer.toHexString(regnum) + ":" + Integer.toHexString(val));
    ...
    static private final IoHandler.IO_ReadHandler read_pci_addr = (port, iolen) -> {
        LOG_PCI.log(Level.DEBUG, "Read PCI address . " + Integer.toString(pci_caddress, 16));
        return pci_caddress;
    };
    ...
    static private final IoHandler.IO_ReadHandler read_pci = (port, iolen) -> {
        LOG_PCI.log(Level.DEBUG, "Read PCI data . " + Integer.toString(pci_caddress, 16));
        ...
        if ((pci_caddress & 0x80ff0000) == 0x80000000) {
            ...
            LOG_PCI.log(Level.DEBUG, "  Read from device " + Integer.toString(devnum, 16) + " register " + Integer.toString(regnum, 16) + " (function " + Integer.toString(fctnum, 16) + "); addr " + Integer.toString(pci_caddress, 16));
            ...
            if (dev != null) {
                switch (iolen) {
                    case 1: {
                        ...
                        logger.log(Level.DEBUG, "PCI 0x" + Integer.toHexString(dev.PCIId()) + " read1 " + Integer.toHexString(regnum) + ":" + Integer.toHexString(val8));
                        return val8;
                    }
                    case 2: {
                        int val16 = read_pci_register(dev, regnum) & 0xFFFF;
                        val16 |= (read_pci_register(dev, regnum + 1) << 8);
                        logger.log(Level.DEBUG, "PCI 0x" + Integer.toHexString(dev.PCIId()) + " read2 " + Integer.toHexString(regnum) + ":" + Integer.toHexString(val16));
                        return val16;
                    }
                    case 4: {
                        ...
                        logger.log(Level.DEBUG, "PCI 0x" + Integer.toHexString(dev.PCIId()) + " read4 " + Integer.toHexString(regnum) + ":" + Integer.toHexString(val32));
                        return val32;
                    }
                    default:
                        break;
    ...
    static final private Callback.Handler PCI_PM_Handler = new Callback.Handler() {
        @Override
        public int call() {
            logger.log(Level.DEBUG, "PCI PMode handler, function " + Integer.toString(CPU_Regs.reg_eax.word(), 16));
    ...
    public int RegisterPCIDevice(PCI_Device device, int slot) {
        ...
        if (pci_devices[slot] != null) {
            ...
            if (subfunction < 0) throw new IllegalStateException("Too many PCI subdevices!");
        }
