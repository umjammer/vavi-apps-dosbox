...
public class VGA_crtc {
    ...
    //		logger.log(Level.TRACE,"Skip lines %d bytes %d",vga.config.hlines_skip,vga.config.bytes_skip);
            /*
    ...
    //		VGA_DetermineMode();
        ...
        default:
            if (VGA.svga.write_p3d5!=null) {
                ...
                LOG_VGAMISC.log(Level.DEBUG, "VGA:CRTC:Write to unknown index "+Integer.toString(VGA.vga.crtc.index,16));
            }
            break;
        }
    };
    ...
    //	LOG_MSG("VGA CRCT read from reg %X",VGA.vga.crtc.index));
        ...
        default:
            if (VGA.svga.read_p3d5!=null) {
                ...
                LOG_VGAMISC.log(Level.DEBUG, "VGA:CRTC:Read from unknown index "+Integer.toString(VGA.vga.crtc.index,16));
                return 0x0;
            }
        }
    };
