...
public class TandySound extends Module_base {
    ...
    private static final Logger logger = System.getLogger(TandySound.class.getName());
    ...
    */
    ...
    static private final IoHandler.IO_ReadHandler TandyDACRead = (port, iolen) -> {
        ...
        logger.log(Level.DEBUG, "Tandy DAC: Read from unknown "+Integer.toString(port,16));
        return 0xff;
    };
