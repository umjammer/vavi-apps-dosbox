...
//            return et4k.store_##port##_##index;
    ...
    static private final VGA.tWritePort write_p3d5_et4k = (reg, val, iolen) -> {
        ...
        */
                ...
                break;
            default:
                LOG_VGAMISC.log(Level.DEBUG, "VGA:CRTC:ET4K:Write to illegal index " + Integer.toString(reg, 16));
                break;
        }
    };
    ...
    static private final VGA.tReadPort read_p3d5_et4k = (reg, iolen) -> {
        ...
        switch (reg) {
            ...
            default:
                LOG_VGAMISC.log(Level.DEBUG, "VGA:CRTC:ET4K:Read from illegal index " + Integer.toString(reg, 16));
                break;
        }
        return 0x0;
    };
    ...
    static private final VGA.tWritePort write_p3c5_et4k = (reg, val, iolen) -> {
        ...
        */
            ...
            case 0x07:
                ...
                break;
            default:
                LOG_VGAMISC.log(Level.DEBUG, "VGA:SEQ:ET4K:Write to illegal index " + Integer.toString(reg, 16));
                break;
        }
    };
    ...
    static private final VGA.tReadPort read_p3c5_et4k = (reg, iolen) -> {
        switch (reg) {
            ...
            default:
                LOG_VGAMISC.log(Level.DEBUG, "VGA:SEQ:ET4K:Read from illegal index " + Integer.toString(reg, 16));
                break;
        }
        return 0x0;
    };
    ...
    */
    ...
    static private final VGA.tWritePort write_p3c0_et4k = (reg, val, iolen) -> {
        ...
        */
            ...
            case 0x17:
                ...
                break;
            default:
                LOG_VGAMISC.log(Level.DEBUG, "VGA:ATTR:ET4K:Write to illegal index " + Integer.toString(reg, 16));
                break;
        }
    };
    ...
    static private final VGA.tReadPort read_p3c1_et4k = (reg, iolen) -> {
        switch (reg) {
            ...
            default:
                LOG_VGAMISC.log(Level.DEBUG, "VGA:ATTR:ET4K:Read from illegal index " + Integer.toString(reg, 16));
                break;
        }
        return 0x0;
    };
...
//            return et3k.store_##port##_##index;
    ...
    static private final VGA.tWritePort write_p3d5_et3k = (reg, val, iolen) -> {
        ...
        */
            ...
            default:
                LOG_VGAMISC.log(Level.DEBUG, "VGA:CRTC:ET3K:Write to illegal index " + Integer.toString(reg, 16));
                break;
        }
    };
    ...
    static private final VGA.tReadPort read_p3d5_et3k = (reg, iolen) -> {
        switch (reg) {
            ...
            default:
                LOG_VGAMISC.log(Level.DEBUG, "VGA:CRTC:ET3K:Read from illegal index " + Integer.toString(reg, 16));
                break;
        }
        return 0x0;
    };
    ...
    static private final VGA.tWritePort write_p3c5_et3k = (reg, val, iolen) -> {
        switch (reg) {
            ...
            case 0x07:
                ...
                break;
            default:
                LOG_VGAMISC.log(Level.DEBUG, "VGA:SEQ:ET3K:Write to illegal index " + Integer.toString(reg, 16));
                break;
        }
    };
    ...
    static private final VGA.tReadPort read_p3c5_et3k = (reg, iolen) -> {
        switch (reg) {
            ...
            default:
                LOG_VGAMISC.log(Level.DEBUG, "VGA:SEQ:ET3K:Read from illegal index " + Integer.toString(reg, 16));
                break;
        }
        return 0x0;
    };
    ...
    static private final VGA.tWritePort write_p3c0_et3k = (reg, val, iolen) -> {
        ...
        switch (reg) {
            ...
            case 0x17:
                ...
                break;
            default:
                LOG_VGAMISC.log(Level.DEBUG, "VGA:ATTR:ET3K:Write to illegal index " + Integer.toString(reg, 16));
                break;
        }
    };
    ...
    static private final VGA.tReadPort read_p3c1_et3k = (reg, iolen) -> {
        switch (reg) {
            ...
            default:
                LOG_VGAMISC.log(Level.DEBUG, "VGA:ATTR:ET3K:Read from illegal index " + Integer.toString(reg, 16));
                break;
        }
        return 0x0;
    };
