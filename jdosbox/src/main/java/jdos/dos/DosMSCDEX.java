        ...
        switch (ioctl_fct) {
            ...
            case 0x01: {/* Get current position */
                ...
                if (addr_mode == 0) {            // HSG
                    ...
                    if (frames < 150)
                        LOG_MISC.log(Level.ERROR, "MSCDEX: Get position: invalid position " + pos.min + ":" + pos.sec + ":" + pos.fr);
                    else frames -= 150;
            ...
            default:
                LOG_MISC.log(Level.ERROR, "MSCDEX: Unsupported IOCTL INPUT Subfunction " + Integer.toString(ioctl_fct, 16));
                return 0x03;    // invalid function
        }
        return 0x00;    // success
    }
    ...
    private static /*Bit16u*/int MSCDEX_IOCTL_Optput(/*PhysPt*/int buffer,/*Bit8u*/short drive_unit) {
        ...
        switch (ioctl_fct) {
            ...
            case 0x05:    // load media
                ...
                break;
            default:
                LOG_MISC.log(Level.ERROR, "MSCDEX: Unsupported IOCTL OUTPUT Subfunction " + Integer.toString(ioctl_fct, 16));
                return 0x03;    // invalid function
        }
        return 0x00;    // success
    }
        ...
        public /*Bitu*/int call() {
            ...
            switch (funcNr) {
                ...
                case 0x88:    /* Resume Audio */
                    ...
                    break;
                default:
                    LOG_MISC.log(Level.ERROR, "MSCDEX: Unsupported Driver Request " + Integer.toString(funcNr, 16));
                    break;
