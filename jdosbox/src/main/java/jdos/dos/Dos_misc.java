...
import jdos.dos.Dos_system.MultiplexHandler;
...
public class Dos_misc {
    ...
    static public List<MultiplexHandler> multiplex;
    ...
    static private final Callback.Handler INT2F_Handler = new Callback.Handler() {
        ...
        public /*Bitu*/int call() {
            for (MultiplexHandler multiplexHandler : multiplex) {
                if (multiplexHandler.call())
                    return Callback.CBRET_NONE;
            }
            LOG_DOSMISC.log(Level.ERROR, "DOS:Multiplex Unhandled call " + Integer.toString(CPU_Regs.reg_eax.word(), 16));
            return Callback.CBRET_NONE;
        }
    };
    ...
    static final Dos_system.MultiplexHandler DOS_MultiplexFunctions = () -> {
        switch (CPU_Regs.reg_eax.word()) {
            case 0x1216:    /* GET ADDRESS OF SYSTEM FILE TABLE ENTRY */
                ...
                LOG_DOSMISC.log(Level.ERROR, "Some BAD filetable call used bx=" + Integer.toString(CPU_Regs.reg_ebx.word(), 16));
            ...
            case 0x4a02:    /* ALLOCATE HMA SPACE */
                LOG_DOSMISC.log(Level.WARNING, "INT 2f:4a HMA. DOSBox reports none available.");
