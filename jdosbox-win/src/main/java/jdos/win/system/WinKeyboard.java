...
public class WinKeyboard {
    ...
    private static final Logger LOG_GUI = System.getLogger("LOG_GUI");

    static public final BitSet keyState = new BitSet();

    static public int win2java(int winVirtualKeyCode) {
        return switch (winVirtualKeyCode) {
            case 0x1B -> KeyEvent.VK_ESCAPE;
            case 0x61 -> KeyEvent.VK_NUMPAD1;
            case 0x31 -> KeyEvent.VK_1;
            case 0x62 -> KeyEvent.VK_NUMPAD2;
            case 0x32 -> KeyEvent.VK_2;
            case 0x63 -> KeyEvent.VK_NUMPAD3;
            case 0x33 -> KeyEvent.VK_3;
            case 0x64 -> KeyEvent.VK_NUMPAD4;
            case 0x34 -> KeyEvent.VK_4;
            case 0x65 -> KeyEvent.VK_NUMPAD5;
            case 0x35 -> KeyEvent.VK_5;
            case 0x66 -> KeyEvent.VK_NUMPAD6;
            case 0x36 -> KeyEvent.VK_6;
            case 0x67 -> KeyEvent.VK_NUMPAD7;
            case 0x37 -> KeyEvent.VK_7;
            case 0x68 -> KeyEvent.VK_NUMPAD8;
            case 0x38 -> KeyEvent.VK_8;
            case 0x69 -> KeyEvent.VK_NUMPAD9;
            case 0x39 -> KeyEvent.VK_9;
            case 0x60 -> KeyEvent.VK_NUMPAD0;
            case 0x30 -> KeyEvent.VK_0;
            case 0x6D -> KeyEvent.VK_SUBTRACT;
            //case KeyEvent.VK_MINUS:break;
            //case KeyEvent.VK_EQUALS:break;
            case 0x08 -> KeyEvent.VK_BACK_SPACE;
            case 0x09 -> KeyEvent.VK_TAB;
            case 0x51 -> KeyEvent.VK_Q;
            case 0x57 -> KeyEvent.VK_W;
            case 0x45 -> KeyEvent.VK_E;
            case 0x52 -> KeyEvent.VK_R;
            case 0x54 -> KeyEvent.VK_T;
            case 0x59 -> KeyEvent.VK_Y;
            case 0x55 -> KeyEvent.VK_U;
            case 0x49 -> KeyEvent.VK_I;
            case 0x4F -> KeyEvent.VK_O;
            case 0x50 -> KeyEvent.VK_P;

            //case KeyEvent.VK_OPEN_BRACKET:break;
            //case KeyEvent.VK_CLOSE_BRACKET:break;
            case 0x0D -> KeyEvent.VK_ENTER;
            case 0x11 -> KeyEvent.VK_CONTROL;
            case 0x41 -> KeyEvent.VK_A;
            case 0x53 -> KeyEvent.VK_S;
            case 0x44 -> KeyEvent.VK_D;
            case 0x46 -> KeyEvent.VK_F;
            case 0x47 -> KeyEvent.VK_G;
            case 0x48 -> KeyEvent.VK_H;
            case 0x4A -> KeyEvent.VK_J;
            case 0x4B -> KeyEvent.VK_K;
            case 0x4C -> KeyEvent.VK_L;

            //case KeyEvent.VK_SEMICOLON:break;
            //case KeyEvent.VK_QUOTE:break;
            //case KeyEvent.VK_BACK_QUOTE:break;
            case 0x10 -> KeyEvent.VK_SHIFT;

            //case KeyEvent.VK_BACK_SLASH:break;
            case 0x5A -> KeyEvent.VK_Z;
            case 0x58 -> KeyEvent.VK_X;
            case 0x43 -> KeyEvent.VK_C;
            case 0x56 -> KeyEvent.VK_V;
            case 0x42 -> KeyEvent.VK_B;
            case 0x4E -> KeyEvent.VK_N;
            case 0x4D -> KeyEvent.VK_M;

            //case KeyEvent.VK_COMMA:break;
            //case KeyEvent.VK_PERIOD:break;
            case 0x6E -> KeyEvent.VK_DECIMAL;
            //case KeyEvent.VK_SLASH:break;
            case 0x6A -> KeyEvent.VK_MULTIPLY;
            case 0x12 -> KeyEvent.VK_ALT;
            case 0x20 -> KeyEvent.VK_SPACE;
            case 0x14 -> KeyEvent.VK_CAPS_LOCK;
            case 0x70 -> KeyEvent.VK_F1;
            case 0x71 -> KeyEvent.VK_F2;
            case 0x72 -> KeyEvent.VK_F3;
            case 0x73 -> KeyEvent.VK_F4;
            case 0x74 -> KeyEvent.VK_F5;
            case 0x75 -> KeyEvent.VK_F6;
            case 0x76 -> KeyEvent.VK_F7;
            case 0x77 -> KeyEvent.VK_F8;
            case 0x78 -> KeyEvent.VK_F9;
            case 0x79 -> KeyEvent.VK_F10;
            case 0x90 -> KeyEvent.VK_NUM_LOCK;
            case 0x91 -> KeyEvent.VK_SCROLL_LOCK;

            // case KeyEvent.VK_PLUS:break;

            // case KeyEvent.VK_LESS:break;
            case 0x7A -> KeyEvent.VK_F11;
            case 0x7B -> KeyEvent.VK_F12;

            //The Extended keys

            case 0x6F -> KeyEvent.VK_DIVIDE;
            case 0x6B -> KeyEvent.VK_ADD;
            case 0x24 -> KeyEvent.VK_HOME;
            case 0x26 -> KeyEvent.VK_UP;
            case 0x21 -> KeyEvent.VK_PAGE_UP;
            case 0x25 -> KeyEvent.VK_LEFT;
            case 0x27 -> KeyEvent.VK_RIGHT;
            case 0x23 -> KeyEvent.VK_END;
            case 0x28 -> KeyEvent.VK_DOWN;
            case 0x22 -> KeyEvent.VK_PAGE_DOWN;
            case 0x2D -> KeyEvent.VK_INSERT;
            case 0x2E -> KeyEvent.VK_DELETE;
            case 0x13 -> KeyEvent.VK_PAUSE;
            case 0x2C -> KeyEvent.VK_PRINTSCREEN;
            default -> -1;
        };
    }

    static public final Main.KeyboardHandler defaultKeyboardHandler = key -> {
        int result = 0;
        int additional = 0;
        ...
        switch (key.getKeyCode()) {
            ...
            default:
                LOG_GUI.log(Level.WARNING,  "Unknown key code: "+key.getKeyCode());
                return;
        }
        if (result != 0) {
            int repeatCount=1;
