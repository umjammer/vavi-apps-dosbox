...
public class Interrupts {
    ...
    public final Callback.Handler[] interrupt_handlers;

    public final int isr0;
    public final int isr1;
    public final int isr2;
    public final int isr3;
    public final int isr4;
    public final int isr5;
    public final int isr6;
    public final int isr7;
    public final int isr8;
    public final int isr9;
    public final int isr10;
    public final int isr11;
    public final int isr12;
    public final int isr13;
    public final int isr14;
    public final int isr15;
    public final int isr16;
    public final int isr17;
    public final int isr18;
    public final int isr19;
    public final int isr20;
    public final int isr21;
    public final int isr22;
    public final int isr23;
    public final int isr24;
    public final int isr25;
    public final int isr26;
    public final int isr27;
    public final int isr28;
    public final int isr29;
    public final int isr30;
    public final int isr31;
    public final int isr128;

    public final int irq0;
    public final int irq1;
    public final int irq2;
    public final int irq3;
    public final int irq4;
    public final int irq5;
    public final int irq6;
    public final int irq7;
    public final int irq8;
    public final int irq9;
    public final int irq10;
    public final int irq11;
    public final int irq12;
    public final int irq13;
    public final int irq14;
    public final int irq15;

    final Callback.Handler isrHandler = new Callback.Handler() {
        @Override
        public int call() {
