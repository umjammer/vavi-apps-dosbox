...
public class ButtonWindow extends WinAPI {
    ...
    static private int ButtonWndProc_common(int hWnd, int uMsg, int wParam, int lParam) {
        ...
        switch (uMsg) {
            case WM_GETDLGCODE:
                return switch (btn_type) {
                    case BS_USERBUTTON, BS_PUSHBUTTON -> DLGC_BUTTON | DLGC_UNDEFPUSHBUTTON;
                    case BS_DEFPUSHBUTTON -> DLGC_BUTTON | DLGC_DEFPUSHBUTTON;
                    case BS_RADIOBUTTON, BS_AUTORADIOBUTTON -> DLGC_BUTTON | DLGC_RADIOBUTTON;
                    case BS_GROUPBOX -> DLGC_STATIC;
                    default -> DLGC_BUTTON;
                };
