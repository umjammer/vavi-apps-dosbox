...
public class DSConvert extends WinAPI {
    ...
    static private final bitsconvertfunc convert_8_to_16 = (s, dst, src_stride, dst_stride, c, f, adj) -> {
    ...
    static private final bitsconvertfunc convert_16_to_16 = (s, dst, src_stride, dst_stride, c, f, adj) -> {
        IntRef count = new IntRef(c);
        IntRef src = new IntRef(s);
        IntRef freqAcc = new IntRef(f);
    ...
    static private final bitsconvertfunc convert_24_to_16 = (s, dst, src_stride, dst_stride, c, f, adj) -> {
        IntRef count = new IntRef(c);
        IntRef src = new IntRef(s);
        IntRef freqAcc = new IntRef(f);
        ShortPtr dest16 = new ShortPtr(dst);
    ...
    static private final bitsconvertfunc convert_32_to_16 = (s, dst, src_stride, dst_stride, c, f, adj) -> {
        IntRef count = new IntRef(c);
        IntRef src = new IntRef(s);
        IntRef freqAcc = new IntRef(f);
        ShortPtr dest16 = new ShortPtr(dst);
    ...
    static private final bitsconvertfunc convert_ieee_32_to_16 = (s, dst, src_stride, dst_stride, c, f, adj) -> {
        IntRef count = new IntRef(c);
        IntRef src = new IntRef(s);
        IntRef freqAcc = new IntRef(f);
        ShortPtr dest16 = new ShortPtr(dst);
